---
title: 算法之冒泡排序
published: 2023-02-25T16:55:05.000Z
description: >-
  - VisuAlgo](https://visualgo.net/en/sorting))   手写冒泡排序 
  毋庸置疑，就是把每一项和下一项做对比，从小到大排序，那么最大的肯定放最后面，需要经过两轮循环  1. 从区间0<= i
  <=arr.length-1的范围中去每一次生成 区间 [0, j]...
tags:
  - 排序算法
  - JavaScript
category: 前端开发

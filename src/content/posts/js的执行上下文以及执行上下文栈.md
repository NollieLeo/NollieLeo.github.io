...
published: 2021-06-05T15:37:38.000Z
description: >-
  js的执行上下文以及执行上下文栈   可执行代码  js的可执行代码（executable code）有哪些？只有可执行代码会创建执行上下文  1.
  全局代码 2. 函数代码 3. eval代码   执行上下文  只有可执行代码会创建执行上下文  当执行到一个函数的时候这里会进行准备工作，  这个准...
tags:
  - 执行上下文
  - 执行上下文栈
  - JavaScript

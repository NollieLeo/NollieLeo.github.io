...
published: 2020-12-24T09:50:41.000Z
description: >-
  对于如下Demo，点击Parent组件的div，触发更新，Son组件会打印child render!么？  tsx function Son()
  {       console.log('child render!');       return <divSon</div; } function
  P...
tags:
  - React
  - React render

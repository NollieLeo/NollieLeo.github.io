---
title: Proxy代理应用场景
published: 2021-06-15T16:55:27.000Z
description: >-
  Proxy 使用场景   1 增强型数组   定义 enhancedArray 函数  javascript function
  enhancedArray(arr) {   return new Proxy(arr, {     get(target, property,
  receiver) {  ...
tags:
  - proxy
  - Javascript

---
title: 算法之链表相交
published: 2021-06-13T16:48:30.000Z
description: >-
  面试题 02.07.链表相交      解题思路： 
  1.假设两个链表相交于A，由于两个链表都是单向链表，所以A后面的所有节点都是两个链表的公共部分。现在要找它们第一个公共节点，如果可以从后往前找，则找到两个链表第一个不相同的节点，其后的节点即为所求。但链表的特点导致其更适合从前向后遍历，如果要从后...
tags:
  - 链表
  - 算法
  - 面试题
...
![image-20210613164949653](./image-20210613164949653.png)

---
title: 高阶组件
published: 2020-03-16T17:43:47.000Z
description: >-
  高阶组件  1.高阶组件定义 高阶组件就是一个函数，且该函数接受一个组件作为参数，并返回一个新的组件   2.函数模拟高阶函数 javascript
  function banana() {     let name = 'wengkaimin';     console.log(${name} li...
tags:
  - 高阶组件
  - 组件
category: Javascript

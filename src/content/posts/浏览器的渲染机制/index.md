---
title: 浏览器的渲染机制
published: 2020-03-25T12:40:54.000Z
description: >-
  浏览器的渲染过程  面试题：在浏览器地址栏里输入一个URL,到这个页面呈现出来，中间会发生什么？ 
  目前市面上常见的浏览器内核可以分为这四种：Trident（IE）、Gecko（火狐）、Blink（Chrome、Opera）、Webkit（Safari）。这里面大家最耳熟能详的可能就是
  Webkit...
tags:
  - 浏览器相关
category: 浏览器

---
title: useRef能做啥？
published: 2021-08-03T15:29:45.000Z
description: >-
  useRef  <uuseRef主要的功能就是。</u  1. 帮助我们获取到DOM元素或者组件实例 2. 保存在组件生命周期内不会变化的值  如下： 
  jsx function TextInputWithFocusButton() {   const inputEl = useRef(null);...
tags:
  - useRef
  - forwardRef
  - useImperativeHandle

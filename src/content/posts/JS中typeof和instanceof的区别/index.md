...
published: 2020-03-31T09:29:49.000Z
description: >-
  undefined, number, string, boolean属于简单的值类型，不是对象。剩下的几种情况——函数、数组、对象、null、new
  Number(10)都是对象。他们都是引用类型。      typeof  javascript console.log(typeof (x)); /...
tags:
  - ES6
  - 基本数据类型和引用类型
category: Javascript

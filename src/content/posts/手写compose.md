---
title: 手写compose
published: 2021-12-13T10:40:26.000Z
description: >-
  compose简介  compose就是执行一系列的任务（函数），比如有以下任务队列  js let tasks = [step1, step2,
  step3, step4]    每一个step都是一个步骤，按照步骤一步一步的执行到结尾，这就是一个compose 
  compose在函数式编程中是一...
tags:
  - compose
  - JavaScript

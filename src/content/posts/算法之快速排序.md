---
title: 算法之快速排序
published: 2023-02-25T19:01:37.000Z
description: >-
  快速排序就是:  1. 选取基准元素 2. 比基准元素小的元素放到左边，大的放右边 3. 在左右子数组中重复步骤一二，直到数组只剩下一个元素 4.
  向上逐级合并数组   基本实现  js function quickSort(arr = []) {   if (arr.length <= 1)
  re...
tags:
  - 排序算法
category: Javascript

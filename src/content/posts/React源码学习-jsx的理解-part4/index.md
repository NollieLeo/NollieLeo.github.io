...
published: 2021-08-21T22:26:48.000Z
description: >-
  jsx理解   JSX和Fiber节点不是同一个东西 。   React Component 和 React Element 也不是一个东西。  
  从编译来看  JSX在babel中会被编译成React.createElement（这也就是为什么需要手动import React from
  'reac...
tags:
  - jsx
  - React

---
title: 单例模式
published: 2020-08-23T13:28:14.000Z
description: "单例模式   保证一个类仅有一个实例，并提供给一个访问它的全局访问点。   1. 实现简单的单例模式  javascript var Singleton = function(name){ \tthis.name = name; } Singleton.instance = null; Singlet..."
tags:
  - 设计模式
  - 单例模式
category: 计算机基础

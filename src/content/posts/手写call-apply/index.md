---
title: '手写call, apply'
published: 2021-06-02T11:04:59.000Z
description: >-
  手写call，apply  这应该是面试最傻逼的题目了， 这类 native code ，用js怎么能实现的完美呢？？？  首先先理解一下call,
  apply具体做了些啥事情   原理   1. 调用形式  首先调用call或者apply的都是函数  js function Person(addr...
tags:
  - call
  - apply
  - JavaScript

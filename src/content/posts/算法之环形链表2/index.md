---
title: 算法之环形链表2
published: 2021-06-13T16:08:49.000Z
description: >-
  142.给定一个链表，返回链表开始入环的第一个节点。 如果链表无环，则返回 null。  说明：不允许修改给定的链表。  进阶：  - 你是否可以使用
  O(1) 空间解决此题？    解法：  1.哈希表  js var detectCycle = function(head) {   //建立一个...
tags:
  - 链表
  - 算法
  - 环形链表
...
![image-20210613161001882](./image-20210613161001882.png)
...
这时候fast再从head开始走，slow从encounter走，他们俩每个都走一步，遇见的时候就刚好在环的入口。
 ...
 ![LC142Floyd'sCircleFinding.jpg](./1621542134-cQRGVb-LC142Floyd'sCircleFinding.jpg) 
